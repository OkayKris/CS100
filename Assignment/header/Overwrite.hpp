#ifndef __OVERWRITER_HPP__
#define __OVERWRITER_HPP__
#include "connector.hpp"
#include "Redirection.hpp"

class Overwriter : public Redirector {
    protected:
        bool pass;
        string executable;
        ...
        string filename;
    public:
        Overwriter(string e, vector<string> al, string fn) {
            executable = e;
            arglist = al;
            filename = fn;
        };
        ...
        void execute() {
            ...
            int filed = open(fn, O_WRONLY | O_TRUNC | O_CREAT, S_IRUSR | S_IRGRP | S_IWGRP | S_IWUSR);
